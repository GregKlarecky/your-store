...
export const categories: ICategory[] = [
  ...
  { name: "accessories", id: 8, children: [61, 62, 63, 64], parent: 6 },
  { name: "bags", id: 61, parent: 8 },
  { name: "wallets", id: 62, parent: 8 },
  { name: "suitcases", id: 63, parent: 8 },
  { name: "belts", id: 64, parent: 8 },
