...
export const categories: ICategory[] = [
  ...
  { name: "shoes", id: 7, children: [22, 23, 24, 25], parent: 6 },
  { name: "brogue", id: 22, parent: 7 },
  { name: "booties", id: 23, parent: 7 },
  { name: "loafers", id: 24, parent: 7 },
  { name: "sandals", id: 25, parent: 7 },
